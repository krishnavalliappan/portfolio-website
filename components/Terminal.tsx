...
const Terminal = () => {
  ...
  return (
    <motion.div
      ...
      className="w-full max-w-4xl mx-auto bg-card/80 text-card-foreground rounded-lg shadow-lg relative overflow-hidden backdrop-blur-sm border border-border"
    >
      <motion.div
      ...
      >
        {/* Terminal Header */}
        <div className="bg-muted/80 p-2 rounded-t-lg flex items-center justify-between border-b border-border">
        ...
        <div className="p-4 sm:p-6 font-mono">
          ...
          >
            {["python", "javascript"].map((lang, index) => (
              <motion.button
                key={lang}
                className={`mr-2 px-3 py-1 rounded-t-lg whitespace-nowrap ${
                  activeTab === lang
